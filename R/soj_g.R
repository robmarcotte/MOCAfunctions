...
soj_g = function(filepath = NA, data = NA, export_format = 'session', freq = 80, step1_sd_threshold = .00375, step2_nest_length = 5, step3_nest_length = 60, step3_orig_soj_length_min = 180){
  ...
  ag_step3_summary$step3_estimate_intensity = predict(PAMethods::stage3_intensity_rf, newdata = ag_step3_summary, type = 'class')
  ag_step3_summary$step3_estimate_type = predict(PAMethods::stage3_activity_rf, newdata = ag_step3_summary, type = 'class')
